...
The Cavatina project is open source and free. You can grab a copy of the fonts and related tools on the link:[GitHub realease page].

[NOTE]
Cavatina works with the latest versions of Chrome, Firefox and Opera.
...
- look at the lin:[keyboard mapping] itself.
