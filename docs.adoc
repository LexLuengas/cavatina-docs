...
For learning how to write music with Cavatina you have a few options, although it is strongly recommended that you do read the sections <<_the_basics>> and <<_the_musical_note>> beforehand. You can

- do the link:[tutorial],
- read on through this documentation, or
- look at the link:[keyboard mapping] itself.
...
ifdef::env-github[]
image::resources/images/seven_notes_US.png
endif::[]
...
ifdef::env-github[]
image::resources/images/keyboard_US.png
endif::[]
...
m| , a A *a A*, 
// Note elongations are used here instead to avoid loading the bold font weight
|
ifndef::env-github[]
[.cavatina]#, a A a~ A~,#
endif::[]
ifdef::env-github[]
image::resources/images/examples/1.png
endif::[]
|====
====
...
|`pass:[, f F f~ f~~ F~ F~~,]` | [.cavatina]#, f F f~ f~~ F~ F~~,#
|====
====
...
|`pass:[, f f` j j`, afj a`fj a`f`j a`f`j`,]` | [.cavatina]#, f f` j j`, afj a`fj a`f`j a`f`j`,#
|====
====
...
|`pass:a[, {endsb} }  {endsb}{endsb} }}  {endsb}~ {endsb}~~ }~ }~~,]` | [.cavatina]#, ] }  ]] }}  ]~ ]~~ }~ }~~,#
|====
====
...
beamed. Currently only pairs of notes can be beamed together.
...
|`pass:[,  dh sj..  d`h` s`..j  d`h s`..j`..,]` | [.cavatina]#,  dh sj..  d`h` s`..j  d`h s`..j`..,#
|====
====
...
| `pass:[,+ f f,_ f f,+_ f f,]` | [.cavatina]#,+ f f,_ f f,+_ f f,#
|====
====
...
| `pass:[_----- D G,_+== ADG ]` | [.cavatina]#pass:[_----- D G,_+== ADG ]#
|====
====
...
| `pass:a[{nbsp}{nbsp}A' A" A'' A"" A>]` | [.cavatina]#pass:[  A' A" A'' A"" A>]#
|====
====
...
¦ `pass:a[{nbsp}{nbsp}d\fh  h`||er  M\\|  Dl{nbsp}]` ¦ [.cavatina]#pass:[  d\fh  h`||er  M\\|  Dl ]#
|====
====
...
| `pass:[  D[ D{ D[` D{` D[[ D[[[[ ]` | [.cavatina]#pass:[  D[ D{ D[` D{` D[[ D[[[[ ]#
|====
====
...
| `pass:[, D F G Do, D F D Go`:oo  D S A }.]` | [.cavatina]#pass:[, D F G Do, D F D Go`:oo  D S A }.]#
|====
====
