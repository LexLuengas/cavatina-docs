...
[IMPORTANT]
To do this tutorial, please visit the link:https://github.com/LexLuengas/cavatina-docs/blob/master/tutorial.html[HTML version] of it.
endif::[]
...
the link:{link-docs}[documentation], we recommend doing so, specially the <<{link-docs}#_the_basics,Basics>> and <<{link-docs}#_the_musical_note,Musical Note>> chapters.
...
you can check out in the link:docs[documentation].
